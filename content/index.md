...
> [!tip] Como usar
> - Navegue pelos **módulos** no menu lateral (à esquerda).
> - Use a **busca** (ícone de lupa ou `Ctrl/Cmd + K`) para achar qualquer tema.
> - Comece pelo **Módulo 0 — Introdução**: ele explica a mentalidade que todo o resto pede.
...
- **Módulo 2 — [[Apostila de Conjuntos|Conjuntos]]** · notação, operações, diagramas de Venn.
- **Módulo 3 — [[Apostila de Aritmética|Aritmética]]** · operações, potências, decimais, primos, mdc/mmc.
- **Módulo 4 — [[Apostila de Sequências|Sequências]]** · números, figuras e palavras.
...
> Boa lógica não é decorar — é **abstrair**. Quanto mais você resolve pela forma, mais fácil fica tudo.
