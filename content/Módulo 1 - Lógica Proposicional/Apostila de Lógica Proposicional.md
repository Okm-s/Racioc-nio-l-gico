> Mapa de conteúdo. Estude de cima para baixo.

A lógica proposicional faz uma coisa só: **transformar frases em símbolos que valem V ou F**, para tirar a subjetividade da análise.
