...
a) João e Maria venceram, ou nenhum dos dois venceu  
b) João venceu e Maria venceu  
c) Nem João nem Maria venceram  
d) João venceu ou Maria venceu  
e) Se João venceu, Maria perdeu
...
a) todo x  
b) existe pelo menos um x com a propriedade P  
c) nenhum x  
d) não existe x  
e) todo x não
...
a) todos reprovarem  
b) um único aluno não passar (contraexemplo)  
c) nenhum passar  
d) metade passar  
e) é impossível derrubar
...
a) todo x tem P  
b) não existe x com a propriedade P  
c) existe x com P  
d) algum x não tem P  
...
a) terceiro incluído  
b) princípio do terceiro excluído / não contradição  
...
a) válido  
b) inválido (negação do antecedente)  
c) Modus Tollens  
d) Modus Ponens  
e) válido (contrapositiva)
...
a) os fatos são verdadeiros  
b) se as premissas forem V, a conclusão é V  
c) há 5 alternativas  
d) a conclusão é opinião  
e) a tabela tem 4 linhas
